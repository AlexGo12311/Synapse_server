...
const I18N = {
    en: {
        ...
        no_groups_subtitle: "Create a group to chat with multiple people",
        ...
        group_message_placeholder: "Message to group...",
        creator: "Creator",
        member: "Member",
        you_joined_group: "You joined the group",
        added_to_group: "{user} added you to the group",
        ...
        confirm_delete: "Delete this group for everyone? This cannot be undone.",
        no_members: "No members",
        no_users_to_add: "No users to add",
        select_members: "Please select members",
    ...
    ru: {
        ...
        groups_tab: "Группы",
        groups_title: "Группы",
        no_groups_title: "Пока нет групп",
        no_groups_subtitle: "Создайте группу для общения с несколькими людьми",
        ...
        group_message_placeholder: "Сообщение в группу...",
        creator: "Создатель",
        member: "Участник",
        you_joined_group: "Вы присоединились к группе",
        added_to_group: "{user} добавил вас в группу",
        ...
        confirm_delete: "Удалить эту группу для всех? Это действие нельзя отменить.",
        no_members: "Нет участников",
        no_users_to_add: "Нет пользователей для добавления",
        select_members: "Пожалуйста, выберите участников",
